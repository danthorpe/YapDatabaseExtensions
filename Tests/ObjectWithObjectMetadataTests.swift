...
class ObjectWithObjectMetadataTests: XCTestCase {
    ...
    func createPersistables() {
        ...
        metadatas = [metadata]
        items.suffixFrom(1).forEach { _ in metadatas.append(NSDate()) }
    }
...
class Base_ObjectWithObjectMetadataTests: ObjectWithObjectMetadataTests {
...
class Functional_Read_ObjectWithObjectMetadataTests: ObjectWithObjectMetadataTests {
...
class Functional_Write_ObjectWithObjectMetadataTests: ObjectWithObjectMetadataTests {
...
class Functional_Remove_ObjectWithObjectMetadataTests: ObjectWithObjectMetadataTests {
...
class Curried_Read_ObjectWithObjectMetadataTests: ObjectWithObjectMetadataTests {
...
class Curried_Write_ObjectWithObjectMetadataTests: ObjectWithObjectMetadataTests {
...
class Persistable_Read_ObjectWithObjectMetadataTests: ObjectWithObjectMetadataTests {
...
class Persistable_Write_ObjectWithObjectMetadataTests: ObjectWithObjectMetadataTests {
...
class Persistable_Remove_ObjectWithObjectMetadataTests: ObjectWithObjectMetadataTests {
